...
namespace SpaceSim
{
    class Astronomy
    {
        public static void Main(String[] args)
        {
            ...
            jupiter.AddMoon(ananke);
            jupiter.AddMoon(carme);
            jupiter.AddMoon(pasiphae);
            jupiter.AddMoon(sinope);

            saturn.AddMoon(atlas);
            saturn.AddMoon(prometheus);
            saturn.AddMoon(pandora);
            saturn.AddMoon(epimetheus);
            saturn.AddMoon(janus);
            saturn.AddMoon(mimas);
            saturn.AddMoon(enceladus);
            saturn.AddMoon(tethys);
            saturn.AddMoon(telesto);
            saturn.AddMoon(calypso);
            saturn.AddMoon(dione);
            saturn.AddMoon(helene);
            saturn.AddMoon(rhea);
            saturn.AddMoon(titan);
            saturn.AddMoon(hyperion);
            saturn.AddMoon(iapetus);
            saturn.AddMoon(phoebe);
